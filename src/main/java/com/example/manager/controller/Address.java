...
public class Address {
    ...
    @Autowired
    private AddressService manager;
    ...
    public ResponseEntity<?> saveAddress(@Valid @RequestBody com.example.manager.data.Address address) {
    ...
    public ResponseEntity<?> updateAddress(@Valid @RequestBody com.example.manager.data.Address addressa, @PathVariable("id") Long id) {
